...
class Item extends GWM.item.Item {
    constructor(kind) {
        super(kind);
    }
    getAction(name) {
...
class ItemKind extends GWM.item.ItemKind {
    constructor(config) {
        super(config);
        this.actions = {};
        if (config.actions) {
...
class Actor extends GWM.actor.Actor {
    constructor(kind) {
        super(kind);
...
class ActorKind extends GWM.actor.ActorKind {
    constructor(opts) {
        super(opts);
...
export { index$1 as action, index$3 as actor, index as game, index$4 as item, index$2 as player };
